                            ...
                            <ul className="list-unstyled topbar-right-menu float-right mb-0">
                                <li className="dropdown notification-list">
                                    ...
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <a href="javascript:void(0);" className="dropdown-item notify-item">
                                                <div className="notify-icon bg-danger"><i className="mdi mdi-heart"></i>
                                                </div>
                                            ...
                                            <a href="javascript:void(0);" className="dropdown-item notify-item">
                                                <div className="notify-icon bg-warning"><i
                                                    className="mdi mdi-comment-account-outline"></i>
                                                </div>
                                                <p className="notify-details">Caleb Flakelar commented on Admin
                                            ...
                                            <a href="javascript:void(0);" className="dropdown-item notify-item">
                                                <div className="notify-icon bg-custom"><i className="mdi mdi-heart"></i>
                                                </div>
                                                <p className="notify-details">Carlos Crouch liked <b>Admin</b>
                                ...
                                <li className="dropdown notification-list">
                                    ...
                                    <div
                                        ...
                                        <div className="dropdown-item noti-title">
                                            <h5 className="m-0"><span className="float-right"><a href=""
                                                                                                 className="text-dark"><small>Clear All</small></a> </span>Chat
                                            </h5>
                                        </div>
                                        ...
                                        <div className="slimscroll">
                                            <a href="javascript:void(0);" className="dropdown-item notify-item">
                                                ...
                                                <p className="text-muted font-13 mb-0 user-msg">Hi, How are you? What
                                                    about our
                                                    next
                                                    meeting</p>
                                            </a>
                                            <a href="javascript:void(0);" className="dropdown-item notify-item">
                                                ...
                                                <p className="text-muted font-13 mb-0 user-msg">Yeah everything is
                                                    fine</p>
                                            </a>
                                ...
                                <li className="dropdown notification-list">
                                    <a className="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#"
                                       role="button"
                                       aria-haspopup="false" aria-expanded="false">
                                        <img src="http://coderthemes.com/highdmin/default/assets/images/users/avatar-2.jpg" alt="user"
                                             className="rounded-circle"/>
                                        <span
                                            className="ml-1">Maxine K <i className="mdi mdi-chevron-down"></i> </span>
                                    </a>
                                    <div
